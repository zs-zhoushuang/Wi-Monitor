...
class Seg_network():
    def __init__(
        ...
        if is_train is False:
            self.saver.restore(self.sess, "./Params_basic_scenario/envir1/TCN_based/params_300/train.ckpt")
            # self.saver.restore(self.sess, "./Params_basic_scenario/envir2/TCN_based/params_300/train.ckpt")
