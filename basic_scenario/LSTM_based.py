...
class Seg_network():
    def __init__(
        ...
        if is_train is False:
            self.saver.restore(self.sess, "./Params_basic_scenario/envir1/LSTM_based/params_300/train.ckpt")
            # self.saver.restore(self.sess, "./Params_basic_scenario/envir2/LSTM_based/params_300/train.ckpt")
...
if __name__ =="__main__":
    ...
    for person_index in range(1, 5, 1):
        for list_index in range(1, 3, 1):
            path = 'TestData_basic_scenario/envir_1/person_' + str(person_index) + '/list_' + str(list_index) + '/'
